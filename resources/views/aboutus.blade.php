...
<div class="container-fluid p-0">
    <img src="{{ asset('images/aboutus.jpg') }}" class="img-fluid full-width-cover" alt="MS Computer Institute">
</div>

<!-- About Section -->
<section class="py-5">
    <div class="container">
        <div class="row mx-3" style="min-height: 100%;">
            <!-- Text Column -->
            <div class="col-lg-8 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        We are excited to announce the opening of our new branch in <strong>Ankleshwar</strong> starting <strong>February 2025</strong>.
                        All our computer courses—including short-term and diploma programs—will be fully available at the Ankleshwar center,
                        offering the same quality education, expert faculty, and hands-on learning environment that MS Computer Institute is known for.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 d-flex align-items-stretch">
                <div class="row g-2 align-content-stretch w-100">
                    <div class="col-6">
                        <img src="{{ asset('images/gallery/ankleshwer_branch4.jpeg') }}" class="img-fluid shadow rounded h-100 object-fit-cover" alt="Branch 1">
                    </div>
                    <div class="col-6">
                        <img src="{{ asset('images/gallery/kitchen_course.jpeg') }}" class="img-fluid shadow rounded h-100 object-fit-cover" alt="Branch 2">
                    </div>
                    <div class="col-6">
                        <img src="{{ asset('images/gallery/ankleshwer_branch3.jpeg') }}" class="img-fluid shadow rounded h-100 object-fit-cover" alt="Branch 3">
                    </div>
                    <div class="col-6">
                        <img src="{{ asset('images/gallery/girls_branch.jpeg') }}" class="img-fluid shadow rounded h-100 object-fit-cover" alt="Branch 4">
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-5">
    <div class="container">
        <h3 class="text-center fw-bold mb-4 text-muted">Our Goals and Objectives</h3>
        <div class="row mx-3">
            <div class="col-md-12">
                <p class="text-black">We aim to train young men and women of quality to be leaders in life. Our mission
...
<section class="py-5 bg-light">
    <div class="container">
        <div class="row g-4 mx-3">
            <div class="col-md-6">
                <h4 class="fw-semibold  text-muted">Our Vision</h4>
                <p class="text-dark">We aspire to provide holistic education to young people, helping them grow
            ...
            <div class="col-md-6">
                <h4 class="fw-semibold text-muted">Our Mission</h4>
                <p class="text-dark">MS Computer Institute nurtures dreams and ignites a passion for excellence. With a
...
<!-- Call to Action -->
<section class="py-5  text-white text-center" style="background-color:rgb(215 225 233) !important;">
    <div class="container">
        ...
        <a href="{{ url('/contactus') }}" class="btn btn-light mt-3 mx-3">Contact Us</a>
    </div>
</section>
