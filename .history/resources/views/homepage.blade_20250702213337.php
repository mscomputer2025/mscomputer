...
@section('content')
    ...
    <section class="py-5 text-center">
        <div class="container">
            <h2 class="fw-bold mb-5 mx-3 heading-styled">Choose the Right Course for Your Future</h2>

            <div class="d-flex flex-nowrap overflow-auto p-4 gap-3">
                @php
                    $courses = [
                ...
                @foreach ($courses as $course)
                    <a href="{{ url('/courses') }}" class="text-decoration-none flex-shrink-0" style="width: 220px;">
                        <div class="course-box p-4 shadow rounded-4 h-100 text-center transition-hover bg-white">
                            <div class="mb-3">
                                <i class="bi bi-{{ $course['icon'] }} text-dark fs-1"></i>
                            </div>
                ...
                <!-- Minimal View More Icon -->
                <a href="{{ url('/courses') }}"
                    class="text-decoration-none flex-shrink-0 d-flex flex-column justify-content-center align-items-center text-center"
                    style="width: 80px; height: 80px; border-radius: 50%; background-color: #f8f9fa; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
                    <i class="bi bi-arrow-right fs-4 text-secondary mb-1"></i>
                    <small class="text-secondary fw-semibold">View more</small>
                </a>
