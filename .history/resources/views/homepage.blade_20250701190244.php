                ...
                @foreach ($courses as $course)
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="course-box p-4 shadow rounded-4 h-100 transition-hover">
                            <div class="mb-3">
                                <i class="bi bi-{{ $course['icon'] }}-fill fs-1 shadow text-dark "></i>
                            </div>
...
<section class="py-5 bg-light">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6">
        <h2 class="fw-bold mb-4">About MS COMPUTER</h2>
        <p>MS Computer Institute, established in 2018 near Muhammadpura Circle, Bharuch (Gujarat), is an ISO 9001:2015 certified institute recognized by the Government of India.</p>
        <p>We are committed to delivering quality education to students, professionals, businessmen, housewives, and working individuals. Our goal is to make computer literacy accessible and practical through easy-to-learn structured training.</p>
        <p>Located in a dynamic industrial region, we provide real-world exposure, instill professional values, and encourage technical excellence through disciplined, hands-on learning.</p>
        <p>We believe in nurturing dreams, shaping young minds, and preparing students to thrive in their careers through technical empowerment, moral integrity, and personal growth.</p>
      </div>

      <div class="col-md-6 text-center">
        <img src="{{ asset('images/aboutus.jpg') }}" alt="MS Computer Institute" class="img-fluid rounded-3 shadow">
      </div>
