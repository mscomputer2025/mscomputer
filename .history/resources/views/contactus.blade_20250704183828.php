...
<div class="container py-5 bg-light">
   <div class="row justify-content-center mx-3">
    <div class="col-lg-10">
        <div class="contact-section rounded shadow" style="background-image: url('{{ asset('images/contactus.jpg') }}'); background-size: cover; background-position: center;">
            <div class="bg-white bg-opacity-75 p-4 p-md-5 rounded">
