...
@section('content')
    ...
    <div class="contact-banner position-relative">
        <img src="{{ asset('images/contact.png') }}" alt="MS Computer Institute" class="w-100 h-100 object-fit-cover">
    </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <img src="{{ asset('images/ankleshwer_branch.png') }}" alt="Ankleshwar Branch"
                    class="card-img-top rounded-top" style="max-height: 300px; object-fit: cover;">
                <div class="card-body text-center">
                    <h5 class="fw-semibold">Ankleshwar Branch</h5>
                    {{-- Optional Contact Info --}}
                    <p class="mb-1"><strong>Address:</strong> Near XYZ Circle, Ankleshwar, Gujarat</p>
                    <p class="mb-1"><strong>Phone:</strong> +91-9876543210</p>
                    <p><strong>Email:</strong> ankleshwar@mscomputer.com</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <img src="{{ asset('images/bharuch_branch.png') }}" alt="Bharuch Branch"
                    class="card-img-top rounded-top" style="max-height: 300px; object-fit: cover;">
                <div class="card-body text-center">
                    <h5 class="fw-semibold">Bharuch Branch</h5>
                    {{-- Optional Contact Info --}}
                    <p class="mb-1"><strong>Address:</strong> Opposite ABC Mall, Bharuch, Gujarat</p>
                    <p class="mb-1"><strong>Phone:</strong> +91-9123456789</p>
                    <p><strong>Email:</strong> bharuch@mscomputer.com</p>
                </div>
            </div>
        </div>
    </div>
