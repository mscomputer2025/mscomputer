    ...
    <section class="py-5 bg-light text-center">
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center g-4">
                <div class="col-6 col-md-4 col-lg-3">
                    <img src="{{ asset('images/iaf.jpg') }}" alt="IAF Logo" class="img-fluid cert-logo rounded-circle">
                </div>
                <div class="col-6 col-md-4 col-lg-3">
                    <img src="{{ asset('images/msme.png') }}" alt="MSME Logo" class="img-fluid cert-logo rounded-circle">
                </div>
                <div class="col-6 col-md-4 col-lg-3">
                    <img src="{{ asset('images/itct.jpg') }}" alt="ITCT Logo" class="img-fluid cert-logo rounded-circle">
                </div>
            </div>
        </div>
    </section>  
