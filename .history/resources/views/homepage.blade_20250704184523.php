...
@section('content')
    ...
    <section class="py-5 text-center">
        <div class="container">
            ...
            <div class="d-flex flex-nowrap overflow-auto p-4 gap-3">
                ...
                @endforeach
                <a href="{{ url('/courses') }}"
                    class="text-decoration-none flex-shrink-0 d-flex justify-content-center align-items-center text-center"
    ...
    <section class="py-5  text-center">
        <div class="container">
            <h2 class="fw-bold mb- typewriter">Certified & Authenticated By</h2>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <h2 class="text-left fw-bold mb-5 mx-3">Our Vision & Mission</h2>
