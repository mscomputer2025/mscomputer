        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is('courses*') ? 'active' : '' }}" href="#" id="coursesDropdown"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('contactus') ? 'active' : '' }}" href="{{ url('/contact') }}">Contact Us</a>
                </li>
