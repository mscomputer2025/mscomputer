    ...
    <section class="py-5 text-center">
        <div class="container">
            ...
            <div class="d-flex flex-nowrap overflow-auto px-3 gap-3">
                ...
                <!-- View More Box -->
                <a href="{{ url('/courses') }}" class="text-decoration-none flex-shrink-0">
                    <div
                        class="course-box p-4 shadow rounded-4 h-100 d-flex flex-column justify-content-center align-items-center transition-hover bg-white">
                        <div class="mb-2">
