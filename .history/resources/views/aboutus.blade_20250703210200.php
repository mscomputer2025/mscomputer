...
@section('content')
    ...
    <div class="container p-0">
        <img src="{{ asset('images/about-hero.jpg') }}" class="img-fluid"
    ...
    <!-- Call to Action -->
    <section class="py-5 bg-primary text-white text-center" style="rgba(var(--bs-white-rgb), var(--bs-text-opacity)) !important;">
        <div class="container">
