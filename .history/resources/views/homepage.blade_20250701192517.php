                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <blockquote class="blockquote text-center">
                            ...
                            <p class="mb-4">"Education shapes civilization and pushes humanity forward. We are here to help
                                our youth experience the future."</p>
                    ...
                    <div class="carousel-item">
                        <blockquote class="blockquote text-center">
                            ...
                            <p class="mb-4">"Excellence and value are not just our principles, but our promise to every
                                student that walks through our doors."</p>
                            <footer class="blockquote-footer">Mustaq Ahmed Shaikh, Director</footer>
                        </blockquote>
                    </div>
                    <div class="carousel-item">
                        <blockquote class="blockquote text-center">
                            ...
                            <p class="mb-4">"We nurture dreams, develop skills, and help youth become self-reliant and
                                ethically strong professionals."</p>
                            <footer class="blockquote-footer">Mustaq Ahmed Shaikh, Director</footer>
                        </blockquote>
                    </div>
                </div>
