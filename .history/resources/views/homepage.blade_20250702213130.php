 ...
 <section class="py-5 text-center">
    <div class="container">
        ...
        <div class="d-flex flex-nowrap overflow-auto p-4 gap-3">
            ...
            <a href="{{ url('/courses') }}" class="text-decoration-none flex-shrink-0 d-flex justify-content-center align-items-center "
               style="width: 64px; height: 64px; border-radius: 50%; background-color: #f8f9fa; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
