        ...
        <div id="quoteCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000" data-bs-pause="hover">
          <div class="carousel-inner text-center">
            <div class="carousel-item active">
              ...
              <p class="fs-5 px-3">Education shapes civilization and pushes humanity forward. We are here to help our youth experience the future.</p>
            </div>
            <div class="carousel-item">
              <i class="bi bi-star-fill fs-1 text-primary mb-3 d-block"></i>
              <p class="fs-5 px-3">Excellence and value are not just our principles, but our promise to every student that walks through our doors.</p>
            </div>
            <div class="carousel-item">
              <i class="bi bi-rocket fs-1 text-danger mb-3 d-block"></i>
              <p class="fs-5 px-3">We nurture dreams, develop skills, and help youth become self-reliant and ethically strong professionals.</p>
            </div>
          </div>
